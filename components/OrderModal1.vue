      ...
      <form id="form" class="bg-white rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div class="mb-4">
          <h5 class="mb-0 text-base text-neutral-600 dark:text-neutral-200">
            ...
            <span id="CONFIRMATION_SHOW_MSN" class="mb-0 text-base text-red-600 dark:text-neutral-200" v-if="userList.length != 0">
            ...
            <div class="relative">
                ...
                <input type="search" v-model="txtDataToFindUser" id="default-search" 
                ...
                dark:focus:border-blue-500" placeholder="Digite o Sobrenome ou Email para Pesquisar um Colaborador..." required>
                ...
                text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">BUSCA</button>
            </div>
        </div>
        <div class="mb-4" v-if="userList.length != 0">
