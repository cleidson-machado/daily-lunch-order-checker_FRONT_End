    ...
    <div id="admin-modal" data-modal-placement="top-center" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative w-full h-full max-w-md md:h-auto">
            ...
            <div class="relative bg-gray-200 rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal header -->
                <div class="px-6 py-1 border-b rounded-t dark:border-gray-600">
                    <h3 class="text-base font-semibold text-gray-900 lg:text-xl dark:text-white">
                        Módulo Administrativo
                    </h3>
                    <span class="text-sm font-normal text-gray-500 dark:text-gray-400 text-left ...">Utilize uma das Opções
                        Abaixo!</span>
                </div>
                <!-- Modal body -->
                <div class="p-2">
                    ...
                    <div class="flex flex-col space-y-4 ...">
                        ...
                        <router-link to="/menus" custom v-slot="{ navigate }">
                            <button v-on:click="navigate" role="link" data-modal-toggle="admin-modal"
                                ...
                                <span class="flex-1 ml-3 whitespace-nowrap text-left ...">CARDÁPIOS</span>
                                <span
                                    class="inline-flex items-center justify-center px-2 py-0.5 ml-3 text-xs font-medium text-gray-500 bg-gray-200 rounded dark:bg-gray-700 dark:text-gray-400">
                                    Adm Only!
                                </span>
